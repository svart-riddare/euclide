...
class Piece
{
	public :
		...
		bool setMutualObstructions(Piece& piece, int assignedMoves, int *requiredMoves = NULL, int *requiredMovesA = NULL, int *requiredMovesB = NULL, bool isFast = true);
		bool setMutualObstructions(Piece& piece, int availableMoves, int assignedMoves, int *requiredMoves = NULL, int *requiredMovesA = NULL, int *requiredMovesB = NULL, bool isFast = true);
	...
	protected :
		...
		int findMutualObstructions(Piece *pieces[2], Square squares[2], int nmoves[2], Moves& moves, MiniHash& processed, int availableMoves, int assignedMoves, int rmoves[2]);
